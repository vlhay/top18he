...
{
echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><form method="get">Url: 
<input name="url" type="text"><br />Nếu leech bài viết về game vui lòng chỉnh sửa giùm..<input type="submit" value="Leech" ></form>';
}
elseif ($_POST['submit']){
...
$lay = explode('<div class="forumtxt">',$title);
$lay = explode('<div class="chiase">',$lay[1]);
$lay = trim($lay[0]);
