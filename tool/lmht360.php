<title>Leech lienminh360.vn</title>
<?php
session_start();
require 'head.php';
...
$title = trim($title[0]);
$lay = explode("<div class='post-body single'>",$lay);
$lay = explode('<div class="social-ring">',$lay[1]);
$lay = trim($lay[0]);
$lay =  str_replace('<script>loadYouTube();</script>','',$lay);
$lay = strip_tags($lay,'<p>,<br>,<b>,<i>,<u>,<strong>,<iframe>,<img>');
