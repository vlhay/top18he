<title>Leech user.hayday.mobi</title>
<?php
session_start();
require 'head.php';
...
$lay = curl_exec($curl);
$title = explode('<h1>',$lay);
$title = explode('</h1>',$title[1]);
$title = trim($title[0]);
$link = explode('<a class="Gdownload" href="',$lay);
$link = explode('"',$link[1]);
$link = trim($link[0]);
$lay = explode('<div class="content-news">',$lay);
$lay = explode('<div style="text-align: center;">',$lay[1]);
$lay = trim($lay[0]);
