<title>Tool leech Conan TT8 remake</title>
<?php
session_start();
require 'head.php';
...
$url = $_GET['url'];
$curl = curl_init();
curl_setopt ($curl, CURLOPT_URL, 'http://m.blogtruyen.com/truyen/conan-tt8-remake/chuong-'.$url);
...
$lay = curl_exec($curl);
$lay = explode('<div class="noidungchap">',$lay);
...
* Tiêu đề:<br/><input type="text" name="title" value="'.$title.'" required=""/><br/>
