<title>Leech nội dung tại gocvn.org</title>
<?php
session_start();
require 'head.php';
...
$title = trim($title[0]);
$lay = explode('<div class="forumtxt"><p>',$lay);
$lay = explode('<div class="mainblok">',$lay[1]);
$lay = trim($lay[0]);
...
* Nội dung:<br/><textarea name="content"><p>'.$lay.'</textarea><br/>
